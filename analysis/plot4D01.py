# -*- coding: utf-8 -*-
"""
Created on Sat Jun 21 12:38:38 2025
...
if __name__ == "__main__":
    ...
    param_names = [r'$\Omega_m$', r'$w$', r'$\beta$', r'$\sigma_{\beta}$']
...
#        'CPL-all-Bolton-bfree',
        'linear-all-Tri-bsig1',
        'linear-all-Guer-bsig1',
#        'linear-all-Bolton-bfree1',
    ...
    for name in model_names:
        fn = os.path.join(base_dir, 'Output', name, f'mcmc_cosmop4D-{name}.npy')
    ...
    plot_triangle_multiple(
        ...
        plot_name='triangle_compare_bsig1.png',
