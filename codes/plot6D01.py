# -*- coding: utf-8 -*-
"""
Created on Sat Jun 21 16:35:26 2025
...
if __name__ == "__main__":
    ...
    param_names = [r'$\Omega_m$', r'$w$', r'$\gamma$', r'$\sigma_{\gamma}$', r'$\beta$', r'$\sigma_{\beta}$']
    ...
    for name in model_names:
        fn = os.path.join(base_dir, 'Output', name, f'mcmc_cosmop6D-{name}.npy')
    ...
    plot_triangle_multiple(
        ...
        plot_name='triangle_compare_gamma6D1.png',
