...
def main():
    ...
    ap.add_argument("--ann_weight", type=float, default=0.3, help="Weight multiplier for ANN log-likelihood term.")
    ...
    ap.add_argument("--intercept_prior_sigma", type=float, default=0.10,
