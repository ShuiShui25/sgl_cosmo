...
REPORT="${OUTDIR}/run_report_sgl146_ann080.md"
LOG_WCDM="/tmp/sgl146_wcdm_main_ann080.log"
LOG_W0WA="/tmp/sgl146_w0wa_main_ann080.log"
...
run_case "wcdm" "sgl146_wcdm_main_ann080" "${LOG_WCDM}"
run_case "w0wa" "sgl146_w0wa_main_ann080" "${LOG_W0WA}"

"${PY}" - <<'PY' >> "${REPORT}"
import os, numpy as np
outdir = "/home/geng/Codes/lensing_cosmo/jax01/output"
cases = [
    ("wcdm", "sgl146_wcdm_main_ann080", ["Om","w","gamma0","gamma_s","log_sig_g","delta0","delta_s","log_sig_d","beta0","log_sig_b"]),
    ("w0wa", "sgl146_w0wa_main_ann080", ["Om","w0","wa","gamma0","gamma_s","log_sig_g","delta0","delta_s","log_sig_d","beta0","log_sig_b"]),
]
...
echo "[DONE] NPZ(wcdm): ${OUTDIR}/posterior_minimal_chunks_sgl146_wcdm_main_ann080.npz"
echo "[DONE] NPZ(w0wa): ${OUTDIR}/posterior_minimal_chunks_sgl146_w0wa_main_ann080.npz"
