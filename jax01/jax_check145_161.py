...
def fullhier_model(
    ...
    *,
    ...
    log_sig_g = numpyro.sample("log_sig_g", dist.Uniform(-5.0, log_sig_g_max))
    log_sig_d = numpyro.sample("log_sig_d", dist.Uniform(-5.0, log_sig_d_max))

    beta0 = numpyro.sample("beta0", dist.Uniform(-0.8, 1.0))
    log_sig_b = numpyro.sample("log_sig_b", dist.Uniform(-5.0, -0.1))
    ...
    numpyro.factor("soft_constraints", -5.0 * soft_penalty)
