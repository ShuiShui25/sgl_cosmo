...
def fullhier_model(
    ...
    *,
    ...
    gamma_lat = gamma0 + gamma_s * zl + sig_g * u_g
    delta_lat = delta0 + delta_s * zl + sig_d * u_d
    gamma_i = 1.01 + (2.99 - 1.01) * jax.nn.sigmoid(0.3 * gamma_lat)
    delta_i = 0.51 + (2.80 - 0.51) * jax.nn.sigmoid(0.3 * delta_lat)
