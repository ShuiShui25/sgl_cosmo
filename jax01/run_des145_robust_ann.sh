...
REPORT="${OUTDIR}/run_report_des_145_robust_ann.md"
LABEL="des145_wcdm_robust_ann010"
LOG="/tmp/${LABEL}.log"
...
{
  echo "# DES robust ANN test (jax_check145)"
  echo
  echo "- Date: $(date -Iseconds)"
  echo "- Script: ${RUN}"
  echo "- Data: ${FITS}"
  echo "- Goal: robust ANN conflict modeling (Student-t), ann_weight=0.10"
  echo
  echo "## Command"
  echo
  echo '```bash'
