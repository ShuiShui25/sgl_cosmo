...
SCRIPT="/home/geng/Codes/lensing_cosmo/jax01/jax_check141.py"
OUTDIR="/home/geng/Codes/lensing_cosmo/jax01/output_lsst_sim"
REPORT="${OUTDIR}/run_report_lsst_sim141.md"
SUMMARY_ROWS="${OUTDIR}/summary_rows_lsst_sim141.txt"
...
{
  echo "# Cosmology Model Run Report (jax_check141 LSSTa sim)"
  echo ""
  echo "- Script: $SCRIPT"
  echo "- Outdir: $OUTDIR"
...
run_model "lsst_sim_wcdm" "wcdm" "$FITS_WCDM"
...
run_model "lsst_sim_w0wa" "w0wa" "$FITS_W0WA"
