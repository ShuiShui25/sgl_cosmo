...
REPORT="${OUTDIR}/run_report_lsst_sim146_ann1.md"
...
run_case "wcdm" "${FITS_WCDM}" "lsst146_wcdm_ann1"
run_case "w0wa" "${FITS_W0WA}" "lsst146_w0wa_ann1"

"${PY}" - <<'PY' >> "${REPORT}"
import os, numpy as np
outdir = "/home/geng/Codes/lensing_cosmo/jax01/output_lsst_sim"
cases = [
    ("wcdm", "lsst146_wcdm_ann1", ["Om", "w", "gamma0", "gamma_s", "delta0", "delta_s"]),
    ("w0wa", "lsst146_w0wa_ann1", ["Om", "w0", "wa", "gamma0", "gamma_s", "delta0", "delta_s"]),
]
