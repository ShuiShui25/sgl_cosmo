#!/usr/bin/env python3
"""ANN ensemble reconstruction with unweighted training and RepeatedKFold model selection."""
...
def parse_args() -> argparse.Namespace:
    ...
    output_dir = script_dir / "output" / "mb_ann_unweighted_repeatedkfold_run"
    ...
    parser = argparse.ArgumentParser(
        description=(
            ...
            "and RepeatedKFold cross-validation."
        ),
        epilog=(
    ...
    parser.add_argument(
        ...
        type=int,
        default=3,
        help="Number of repeats for RepeatedKFold model selection.",
    )
    parser.add_argument(
        "--max-iter",
        type=int,
...
def cross_validate_hyperparameters(
    ...
    cv = RepeatedKFold(n_splits=args.cv_folds, n_repeats=args.cv_repeats, random_state=args.seed)
    search = GridSearchCV(
        estimator=estimator,
...
def main() -> None:
    ...
    print("Best CV score (neg composite loss, RepeatedKFold):", best_cv_score)
        ...
        json.dumps(
            {
                ...
                "variant": "unweighted_repeatedkfold",
