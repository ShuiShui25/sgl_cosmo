#!/usr/bin/env python3
"""ANN ensemble reconstruction of Pantheon+ corrected apparent magnitude with stronger alpha regularization."""
...
def parse_args() -> argparse.Namespace:
    ...
    output_dir = script_dir / "output" / "mb_ann_highalpha_run"
    ...
    parser = argparse.ArgumentParser(
        description=(
            ...
            "scikit-learn MLP ensemble on a supplied redshift frame, using stronger alpha regularization."
        ),
        epilog=(
...
def build_regressor(
    ...
    mlp = MLPRegressor(
        ...
        alpha=model_params.get("alpha", 1.0e-2),
