#!/usr/bin/env python3
"""ANN ensemble reconstruction with inverse-density sample weighting in residual space."""
...
def parse_args() -> argparse.Namespace:
    ...
    output_dir = script_dir / "output" / "mb_ann_inverse_density_standard_run"
    ...
    parser = argparse.ArgumentParser(
        description=(
            ...
            "scikit-learn MLP ensemble on a supplied redshift frame, using inverse-density sample weighting "
            "so sparse-redshift regions receive larger effective weight in residual-space training."
        ),
        epilog=(
...
def main() -> None:
    ...
    print("Best CV score (neg residual+derivative loss):", best_cv_score)
