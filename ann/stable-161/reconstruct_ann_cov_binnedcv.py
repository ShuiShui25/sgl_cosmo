#!/usr/bin/env python3
"""ANN ensemble reconstruction with unweighted training and redshift-binned stratified cross-validation."""
...
def parse_args() -> argparse.Namespace:
    ...
    output_dir = script_dir / "output" / "mb_ann_unweighted_binnedcv_run"
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "from the sorted unique redshifts appearing in zl and zs, then overwrite/add "
...
def build_updated_lens_fits_path(path: Path) -> Path:
    return path.with_name("SGLTable_ANN_cov.fits")
...
def main() -> None:
    ...
    if lens_table is not None:
        ...
        updated_lens_fits = build_updated_lens_fits_path(args.lens_fits)
        lens_table.write(updated_lens_fits, overwrite=True)
