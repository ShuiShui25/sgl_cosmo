#!/usr/bin/env python3
"""ANN ensemble reconstruction of Pantheon+ corrected apparent magnitude with extra high-z training weights."""
...
def parse_args() -> argparse.Namespace:
    ...
    output_dir = script_dir / "output" / "mb_ann_highz_weight_run"
    ...
    parser = argparse.ArgumentParser(
        description=(
            ...
            "scikit-learn MLP ensemble on a supplied redshift frame, with extra training weight at high redshift."
        ),
        epilog=(
