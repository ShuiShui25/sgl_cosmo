#!/usr/bin/env python3
"""ANN ensemble reconstruction of Pantheon+ corrected apparent magnitude with inverse-density weighting."""
...
def parse_args() -> argparse.Namespace:
    ...
    output_dir = script_dir / "output" / "mb_ann_inverse_density_run"
    ...
    parser = argparse.ArgumentParser(
        description=(
            ...
            "so sparse-redshift regions receive larger effective weight."
        ),
        epilog=(
