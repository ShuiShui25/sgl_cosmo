...
# -*- coding: utf-8 -*-
"""
Created on Fri May 10 16:42:54 2024
...
for p_med_mad in p_list:
    ...
    median_list.append(df_tmp['median'][0])
    mad_tmp.append(df_tmp['mad'][0])

zbin_constraints = {"z":z_list,"gamma_median":median_list,"gamma_mad":mad_tmp}
import csv

# Save dictionary as a CSV file
output_csv = os.path.join(output_path,f'zbin_gamma_constraints_{prior}.csv')
...
print("CSV file has been created:", f'zbin_gamma_constraints_{prior}.csv')
