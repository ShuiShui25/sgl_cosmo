...
class ANN:
    ...
    def __init__(self, 
                 ...
                 epochs= 300,  
                 # save_model_as=r'/home/astrodust/SG/sgl/Output/ANN/weights_ANN.h5',
                 save_model_as=r'/home/astrodust/SG/sgl/Output/ANN/weights_ANN_Ola-full.h5',
                 output_folder =None
                   ):
    ...
    def read_data(self):
        ...
        #print(os.path.join(self.path_project, 'Data' , 'Pantheon+SH0ES.dat'))
        data = ascii.read(os.path.join(self.path_project, 'Data' , 'Pantheon+SH0ES.dat'))
        # data = Table.read(os.path.join(self.path_project, 'Data' , 'SN_sim_ZTF+LSST.fits'))
        # data = unique(data,keys='CID')
        # data.sort('mBERR')            
        #print(data)
        return data
    ...
    def main(self,):
        ...
        if os.path.isfile(os.path.join(self.output_folder, self.save_model_as)):
            ...
            # self.model = keras.models.load_model(os.path.join(self.output_folder, 
            #                                                   self.save_model_as), 
            #                                      compile=False, 
            #                                      custom_objects={'mse': 'mse'} )
            model_path = os.path.join(self.output_folder, self.save_model_as)
            self.model = keras.models.load_model(
                ...
                custom_objects={
                    ...
                    'Adam':           Adam,
                    # you can leave 'mse' out here—Keras already knows MSE
                }
            )
