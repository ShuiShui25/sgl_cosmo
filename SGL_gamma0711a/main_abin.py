...
lens_table_path = os.path.join(path_project, 'Data' , 'SGLTable_fullbin01.fits')
nwalkers = 200
nsteps = 20000
...
#this can be None
model_name_out_list = ['ANNgood_fullbin01_'+prior]
...
lens_table_path = os.path.join(path_project, 'Data' , 'SGLTable_fullbin02.fits')
nwalkers = 200
nsteps = 20000
#if true runs usinf the checkpoint system
checkpoint = True
...
#this can be None
model_name_out_list = ['ANNgood_fullbin02_'+prior]
...
lens_table_path = os.path.join(path_project, 'Data' , 'SGLTable_fullbin03.fits')
nwalkers = 200
nsteps = 20000
#if true runs usinf the checkpoint system
checkpoint = True
...
#this can be None
model_name_out_list = ['ANNgood_fullbin03_'+prior]
...
lens_table_path = os.path.join(path_project, 'Data' , 'SGLTable_fullbin04.fits')
nwalkers = 200
nsteps = 20000
#if true runs usinf the checkpoint system
checkpoint = True
...
#this can be None
model_name_out_list = ['ANNgood_fullbin04_'+prior]
...
lens_table_path = os.path.join(path_project, 'Data' , 'SGLTable_fullbin05.fits')
nwalkers = 200
nsteps = 20000
#if true runs usinf the checkpoint system
checkpoint = True
...
#this can be None
model_name_out_list = ['ANNgood_fullbin05_'+prior]
