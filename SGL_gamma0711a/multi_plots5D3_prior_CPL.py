...
samples_file1 = "/home/gengs/Codes/projects/GLS_Gamma/Gamma_codes/sgl_gamma/Output/ANNgood-Tri_gamma-zl_Koopmans_5D_scale_nw_400_ns_20000/mcmc_samples_Koopmans_5D_scale.npy"  # Update this path
samples_file2 = "/home/gengs/Codes/projects/GLS_Gamma/Gamma_codes/sgl_gamma/Output/ANNgood-Guerrini2024_gamma-zl_Koopmans_5D_scale_nw_400_ns_20000/mcmc_samples_Koopmans_5D_scale.npy" # Update this path
samples_file3 = "/home/gengs/Codes/projects/GLS_Gamma/Gamma_codes/sgl_gamma/Output/ANNgood-Bolton2006_gamma-zl_Koopmans_5D_scale_nw_400_ns_20000/mcmc_samples_Koopmans_5D_scale.npy"

contour_label = ["Triangular Prior","Guerrini2024 Prior","Bolton2006 prior"]
param_names = [r'$\gamma_0^{gCPL}$', r'$\gamma_S^{gCPL}$', r'$\delta_0^{gCPL}$', r'$\delta_S^{gCPL}$', r'$\beta^{gCPL}$']
...
# output_folder = None
plot_name = 'Posterior_Dist_5D_CPL.pdf'
...
plot_tri_GetDist_from_files(samples1, samples2, samples3, param_names, contour_label,output_folder,
                            plot_name, marker = True)

print(calculate_marginal_peak_and_mad(samples1))
print(calculate_marginal_peak_and_mad(samples2))
print(calculate_marginal_peak_and_mad(samples3))
print("=============================================")
