...
zbin_constraints = {"z":z_list,"delta_median":median_list,"delta_mad":mad_tmp}
import csv

# Save dictionary as a CSV file
output_csv = os.path.join(output_path,f'zbin_delta_constraints_{prior}.csv')
...
print("CSV file has been created:", f'zbin_delta_constraints_{prior}.csv')
...
plt.savefig(os.path.join(output_path,f'linear_z_{prior}_delta.png'))
print("Figure saved!")