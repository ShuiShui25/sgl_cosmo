...
from mcmc_utils import lnprob_K_3D_Guerrini2024, lnprob_K_3D_Bolton2006,lnprob_K_3D_fixdelta_Guerrini2024
import numpy as np
...
lens_table_path = os.path.join(path_project, 'Data' , 'SGLTable_sim041.fits')
nwalkers = 200
nsteps = 20000
...
#this can be None
name_model_out_list = ['SGLTable_sim041-ANN-0.22']
...
for name_model, table,model_name_out  in zip(name_model_list, table_list, name_model_out_list) :
    ...
    mcmc_K_beta = MCMC(lens_table_path = table ,
                path_project=path_project,
            model=name_model, nwalkers=nwalkers, nsteps = 20000, mode='Koopmans_3D',  x_ini= [2.078,0.0,0.22],
            checkpoint=checkpoint, ncpu=ncpu, color_points=color_points,
            model_name_out =model_name_out,lnprob_touse= lnprob_K_3D_fixdelta_Guerrini2024)
    mcmc_K_beta.main()    
    print('Done! \n')
...
#    print('Done! \n')
    ...
    #             model=name_model, nwalkers=nwalkers, nsteps = 20000, mode='Koopmans_3D',  x_ini= [2.0,2.0,0.],
    #             checkpoint=checkpoint, ncpu=ncpu, color_points=color_points,
    #             model_name_out =model_name_out,lnprob_touse= lnprob_K_3D_Bolton2006)
    # mcmc_K_beta.main()    
    # print('Done! \n')
